...
%prep
%setup -q -n jupyter_packaging-0.12.0
cd %{_builddir}/jupyter_packaging-0.12.0
pushd ..
cp -a jupyter_packaging-0.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653340498
...
cp %{_builddir}/jupyter_packaging-0.12.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-jupyter_packaging/7a88a926691422ae250d28e9a8214e9e40469383
