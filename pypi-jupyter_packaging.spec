...
%prep
%setup -q -n jupyter_packaging-0.12.2
cd %{_builddir}/jupyter_packaging-0.12.2
pushd ..
cp -a jupyter_packaging-0.12.2 buildavx2
popd
...
cp %{_builddir}/jupyter_packaging-0.12.2/LICENSE %{buildroot}/usr/share/package-licenses/pypi-jupyter_packaging/7a88a926691422ae250d28e9a8214e9e40469383
