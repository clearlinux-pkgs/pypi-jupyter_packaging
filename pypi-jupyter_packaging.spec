...
Version  : 0.12.1
Release  : 35
URL      : https://files.pythonhosted.org/packages/b6/6f/d83e50a3ffc279b4d8dca46d5f72f35617587ec78cadcbccb4990ab23336/jupyter_packaging-0.12.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/b6/6f/d83e50a3ffc279b4d8dca46d5f72f35617587ec78cadcbccb4990ab23336/jupyter_packaging-0.12.1.tar.gz
...
%prep
%setup -q -n jupyter_packaging-0.12.1
cd %{_builddir}/jupyter_packaging-0.12.1
pushd ..
cp -a jupyter_packaging-0.12.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654036827
...
cp %{_builddir}/jupyter_packaging-0.12.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-jupyter_packaging/7a88a926691422ae250d28e9a8214e9e40469383
